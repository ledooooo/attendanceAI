...
export default function PricingPage() {
  const services = [
    ...
    { name: 'المبادرات', price: 'مجـــانا بالكامل' },
    { name: 'تنمية الاسرة', price: 'مجـــانا بالكامل' },
    { name: 'صورة دم كاملة', price: '55 ج.م' },
    { name: 'تحليل بول', price: '20 ج.م' },
    { name: 'تحليل براز', price: '20 ج.م' },
    { name: 'تحليل حمل بالدم', price: '55 ج.م' },
    { name: 'فصيلة دم', price: '20 ج.م' },
    { name: 'صورة دم كاملة', price: '55 ج.م' },
    { name: 'خلع سن', price: '50 ج.م' },
    { name: 'خلع ضرس عقل', price: '100 ج.م' },
    { name: 'تنظيف اسنان', price: '120 ج.م' },
    { name: 'فحص قاع عين', price: '50 ج.م' },
    { name: 'كشف نظارة', price: '65 ج.م' },
    { name: 'كشف نظارة + فحص قاع عين', price: '100 ج.م' },
