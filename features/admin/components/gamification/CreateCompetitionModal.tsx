...
import { User, Save, X, Loader2, Users, Plus, Trash2 } from 'lucide-react';
...
export default function CreateCompetitionModal({ onClose }: { onClose: () => void }) {
    ...
    const [selectedEmp, setSelectedEmp] = useState(''); // للاختيار المؤقت
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            // 2. إنشاء الأسئلة (موجهة للفرق: 1 أو 2)
            // ملاحظة: هنا نضع أسئلة عامة كمثال، يمكنك لاحقاً جعلها ديناميكية
            const questions = [
                // 3 أسئلة للفريق الأول
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="border-2 border-red-100 rounded-xl p-3 bg-red-50/30">
                            ...
                            <div className="space-y-1">
                                ...
                                {team1.length === 0 && <p className="text-[10px] text-gray-400 text-center">لا يوجد أعضاء</p>}
                            </div>
                        </div>
                        ...
                        <div className="border-2 border-blue-100 rounded-xl p-3 bg-blue-50/30">
                            ...
                            <div className="space-y-1">
                                ...
                                {team2.length === 0 && <p className="text-[10px] text-gray-400 text-center">لا يوجد أعضاء</p>}
                            </div>
                        </div>
                    </div>
