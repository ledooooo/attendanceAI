...
import { 
    ...
    Trash2, UserPlus, GraduationCap, Gamepad2 // ✅ استيراد Gamepad2 للألعاب
} from 'lucide-react';
...
export default function AdminDashboard() {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'live_games': return <LiveGamesArena />; // ✅ صفحة الألعاب
...
// ✅ إضافة تبويب الألعاب هنا
const menuItems = [
    { id: 'home', label: 'الرئيسية', icon: Home },
    { id: 'live_games', label: 'صالة الألعاب', icon: Gamepad2 }, // ✅ تمت الإضافة
